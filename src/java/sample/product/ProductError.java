...
public class ProductError {
    ...
    public ProductError(String productIDError, String productNameError, String imageError, String priceError, String quantityError, String catagoryError, String importDateError, String usingDateError) {
        this.productIDError = productIDError;
        this.productNameError = productNameError;
        this.imageError = imageError;
        this.priceError = priceError;
        this.quantityError = quantityError;
        this.catagoryError = catagoryError;
    ...
    public String getCatagoryError() {
        return catagoryError;
    }

    public void setCatagoryError(String catagoryError) {
        this.catagoryError = catagoryError;
    }
